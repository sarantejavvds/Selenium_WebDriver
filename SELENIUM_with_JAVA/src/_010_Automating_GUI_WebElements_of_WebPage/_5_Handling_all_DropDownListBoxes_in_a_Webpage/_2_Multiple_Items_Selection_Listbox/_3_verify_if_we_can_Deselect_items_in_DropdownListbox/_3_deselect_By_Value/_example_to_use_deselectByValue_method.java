package _010_Automating_GUI_WebElements_of_WebPage._5_Handling_all_DropDownListBoxes_in_a_Webpage._2_Multiple_Items_Selection_Listbox._3_verify_if_we_can_Deselect_items_in_DropdownListbox._3_deselect_By_Value;
...
public class _example_to_use_deselectByValue_method
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Is the DropdownListbox can select Mutiple Items? : " + multiple_selection_dropdownlist.isMultiple());
		        ...
		        multiple_selection_dropdownlist.deselectByValue("golden");
		        multiple_selection_dropdownlist.deselectByValue("silver");
